console.log("Mail controlelrs")
 App.controller('adminMailBoxControllers', ["$scope", "colors","APISource","$http","$stateParams","$cookieStore", function($scope, colors,APISource,$http,$stateParams,$cookieStore) {
...
success(function(data) {
  ...
  $scope.mails =data.conversations;
   console.log("recieved mails :"+$scope.mails);
...
App.controller('AdminMailInBoxControllers', ['$scope', 'mails', '$stateParams','$http','$filter','APISource','$cookieStore', function($scope, mails, $stateParams,$http,$filter,APISource,$cookieStore) {
