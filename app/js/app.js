...
// Global Item data service
App.factory('Data', function(){
    var remote = "http://gotomychild.elasticbeanstalk.com" ;
    var local = "http://localhost:8080/myChildProd";
    var currentUsed =local;
    return {
      rootUrl: local ,   //Api path
          
       clientRootUrl: local,
       
       currentApiPoint : currentUsed
    };
});

// Global Item data service
App.factory('APISource', function(){
    var remote = "http://gotomychild.elasticbeanstalk.com" ;
    var local = "http://localhost:8080/myChildProd";
    var currentUsed = local;
    return {
...
$urlRouterProvider.when('/', ['$cookieStore', function ($cookieStore) {
        if(!getLocalToken()){
                         ...
                         else
                         {
                                            ...
                                            var role=roleArray[$cookieStore.get("role")];
                                            return '/'+role+'/home';
                         }
    }
]);
  ...
  $stateProvider
   ...
   .state('admin', {
        url: '/admin',
        abstract: true,
        templateUrl: helper.basepath('admin/app.html'),
        ...
        resolve: helper.resolveFor('fastclick', 'modernizr', 'icons', 'screenfull', 'animo', 'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl')
                     ...
                     url: '/home',
                     title: "Welcome admin",
                     templateUrl: helper.basepath('admin/dashboard.html'),
                     resolve: helper.resolveFor('flot-chart','flot-chart-plugins')
                 })
                     .state('admin.classes', {
                     url: '/classes',
                     title: "Classes",
                     templateUrl: helper.basepath('admin/classes.html'),
                     resolve: helper.resolveFor('angularBootstrapNavTree','gradeControllers','ngTable', 'ngTableExport')
                    })  .state('admin.classView', {
                         url : "/classView/{cid:[0-9]{1,9}}",
                         title: "Classes",
                         templateUrl: helper.basepath('admin/editClass.html'),
                         resolve:helper.resolveFor('adminClassEditController')
                    
                    }) 
                     .state('admin.students', {
                     url: '/students',
                     title: "students",
                     templateUrl:helper.basepath('admin/students.html') ,
                     controller : function($state){ if($state.current.url == '/students') {   $state.go('admin.students.classlist'); }   },
                     resolve : helper.resolveFor('adminStudentControllers','ngTable', 'ngTableExport')
                 }) 
                               .state('admin.students.classlist', {
                                    url: '/classlist',
                                    title: "students",
            controller: function($scope){ $scope.studentList() },
                                    templateUrl : helper.basepath('admin/classlist.html'),
      
                                
      
                                })  .state('admin.students.new', {
                                    url: '/new',
                                    title: "students",
                                    
                                    templateUrl : helper.basepath('admin/newstudent.html') ,
                                    resolve : helper.resolveFor('saveStudentController','ui.select', 'taginput','inputmask','localytics.directives','parsley')
                                })  .state('admin.students.import', {
                                    url: '/import',
                                    title: "students",
                                    templateUrl : helper.basepath('admin/importExcelStudent.html'),
                                    resolve : helper.resolveFor( 'angularFileUpload', 'filestyle')
                                   
                                })    .state('admin.students.search', {
                                    url: '/search',
                                    title: "students",
                                     templateUrl: helper.basepath('admin/studentsearch.html'),
                                     resolve: helper.resolveFor('moment', 'localytics.directives', 'ui.bootstrap-slider')
                                })
                                .state('admin.students.edit', {
                                    url : "/{sid:[0-9]{1,9}}",
                                    title: "view and edit students",
                                     templateUrl: helper.basepath('admin/editStudent.html'),
                                     resolve: helper.resolveFor('adminStudentEditController')
                                })
                                
            .state('admin.notice',{
                url:'/notice',
               title:"Notice",
               templateUrl:helper.basepath('admin/notices.html'),
               resolve:helper.resolveFor('admiNoticeControllers','ngTable', 'ngTableExport')
            }) .state('admin.notice.edit',{
                url:'/edit',
               title:"Notice",
               controller:function($scope){   },
               templateUrl:helper.basepath('admin/notices.html'),
               resolve:helper.resolveFor('admiNoticeControllers','ngTable', 'ngTableExport')
            }) .state('admin.viewEditnotice',{
                 url : "/notice/{nid:[0-9]{1,9}}",
               title:"Notice",
               templateUrl:helper.basepath('admin/viewEditNotice.html'),
               resolve:helper.resolveFor('admiNoticeEditControllers')
            })             
            ...
            .state('admin.Teachers', {
                     url: '/Teachers',
                     title: "Teacher",
                     templateUrl: helper.basepath('admin/teachers.html'),
                     resolve : helper.resolveFor('adminTeacherControllers','ngTable', 'ngTableExport'),
                     controller : function($state){ if($state.current.url == '/Teachers') {   $state.go('admin.Teachers.teacherList'); }   }
                                })   .state('admin.Teachers.new',{
                                        url:'/new',
                                        title:'Add new teacher',
                                        templateUrl:helper.basepath('admin/newTeacher.html'),
                                        resolve: helper.resolveFor('parsley','toaster'),
                                        controller: function($scope) {
                                                                            $scope.addNew();
                                                                          }
                                        

                                     }).state('admin.Teachers.teacherList',{
                                        url:'/teacherList',
                                        title:'Teacher List',
                                        templateUrl:helper.basepath('admin/teacherlist.html'),
                                        ...
                                        controller: function($scope) {
                                                    ...
                                                    .state('admin.Teachers.view', {
                                                    url : "/{tid:[0-9]{1,9}}",
                                                    title: 'View and Edit teacher',
                                                    templateUrl: helper.basepath('admin/editTeacher.html'),
                                                    resolve: helper.resolveFor('adminEditTeacherController')
                                                })
                                        ...
                                        .state('admin.Teachers.departments',{
                                        url:'/departments',
                                        title:'Teacher Departments',
                                        templateUrl:helper.basepath('admin/teacherDepartments.html'),
                                        resolve: helper.resolveFor('ngTable', 'ngTableExport','ui.select'),
                                        controller: function($scope) {
                                                                            $scope.teacherDepartments();
                                                                          }
                                        

                                     }).state('admin.Teachers.classTeachers',{
                                        url:'/classTeachers',
                                        title:'Class Teachers',
                                        templateUrl:helper.basepath('admin/classTeachers.html'),
                                     ...
                                     }).state('admin.Teachers.class_subjects',{
                                        url:'/class_subjects',
                                        title:'Teacher-Class-Subjects',
                                        resolve: helper.resolveFor('ui.select'),
                                        templateUrl:helper.basepath('admin/class_subjects.html'),
                                        
                                        controller: function($scope) {
                                                                            $scope.teacherClassesAndSubjects();
                                                                          }
                                        

                                     })
                         
                                    .state('admin.Teachers.teacherEval',{
                                        url:'/teacherEvaluation',
                                        title:'Teacher Evaluation',
                                        templateUrl:helper.basepath('admin/teacherEval.html') ,
                                        resolve: helper.resolveFor('angularFileUpload', 'filestyle'),
                                        controller: function($scope) {
                                                                            $scope.teacherEval();
                                                                          }})
             ...
             .state('admin.form-wizard', {
        url: '/form-wizard',
        title: 'Form Wizard',
        templateUrl: helper.basepath('admin/form-wizard.html'),
        resolve: helper.resolveFor('parsley')
            ...
            .state('admin.Events', {
                                        url: '/events',
                                        title: 'Events',
                                        templateUrl: helper.basepath('admin/calendar.html'),
                                        
                                        resolve: helper.resolveFor('jquery-ui', 'jquery-ui-widgets', 'moment', 'fullcalendar','admiEventControllers')
                                            }) 
						.state('admin.EventsList',
                             {
                                url : "/events/list" ,
                                title:'Event list' ,
                                templateUrl:helper.basepath('admin/eventlist.html') ,
                                resolve:helper.resolveFor('adminEventListController','ngTable', 'ngTableExport')
                             }
                           ) 
                   .state('admin.EventsView', {
                     url : "/view/{eid:[0-9]{1,9}}",
                     title: "Edit Subject",
                     resolve : helper.resolveFor('adminEventEditControllers'),
                     templateUrl :  helper.basepath('admin/editEvent.html')
                 })
                     ...
                     url: '/Exams',
                     title: "Exams",
                     controller : function($state){ if($state.current.url == '/Exams') {   $state.go('admin.Exams.examlist'); }   } ,
                     resolve : helper.resolveFor('adminExamControllers','ngTable', 'ngTableExport'),
                     templateUrl : helper.basepath('admin/exam.html'),
                     })           .state('admin.Exams.examlist', {
                                        url: '/examlist',
                                        title: "Exam List",
                                        controller: function($scope) {
                                                                            $scope.examlistControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/examlist.html'),
                                    })  .state('admin.Exams.new', {
                                        url: '/new',
                                        title: "Exam List",
                                         resolve: helper.resolveFor('ui.select'),
                                         controller: function($scope) {
                                                                            $scope.newExamControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/newexam.html'),
                                    })  .state('admin.Exams.schedule', {
                                        url: '/schedule',
                                        title: "Exam List",
                                        controller: function($scope) {
                                                                            $scope.examScheduleControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/examschedule.html'),
                                    })   .state('admin.Exams.syllabus', {
                                        url: '/syllabus',
                                        title: "Exam List",
                                         controller: function($scope) {
                                                                            $scope.examSyllabusControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/examsyllabus.html'),
                                    })   .state('admin.Exams.classExam', {
                                        url: '/classExam',
                                        title: "Exam List",
                                         controller: function($scope) {
                                                                            $scope.classExamsControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/classexams.html'),
                                    })  .state('admin.Exams.generalExam', {
                                        url: '/generalExam',
                                        title: "Exam List",
                                         controller: function($scope) {
                                                                            $scope.generalExamsControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/generalexams.html'),
                                    })   .state('admin.Exams.results', {
                                        url: '/results',
                                        title: "Exam List",
                                         controller: function($scope) {
                                                                            $scope.examResultControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/results.html'),
                                    })
                                 
            
            .state('admin.attendance' ,{
                
                 url: '/attendance' ,
               title: 'Attendance',
               contoller : function(){},
               resolve : helper.resolveFor('adminAttendanceControllers','ngTable', 'ngTableExport'),
               templateUrl : helper.basepath('admin/attendance.html')
               ...
               title: 'Gallery',
               contoller : function(){},
               resolve : helper.resolveFor('adminGalleryControllers'),
               templateUrl : helper.basepath('/admin/gallery.html')
               
               
            })
              .state('admin.newGallery' ,{
                
                 url: '/gallery/new' ,
               title: 'New Gallery',
               contoller : function(){},
               resolve : helper.resolveFor('adminGalleryControllers','angularFileUpload', 'filestyle'),
               templateUrl : helper.basepath('/admin/newGallery.html')
            ...
            .state('admin.TimeTables', {
                     url: '/TimeTables',
                     title: "TimeTables",
                     resolve : helper.resolveFor('adminTimeTableControllers','ngTable', 'ngTableExport'),
                     controller: function($state){ if($state.current.url == '/TimeTables') {   $state.go('admin.TimeTables.classTimeTable'); }   },
                     templateUrl: helper.basepath('admin/timetable.html')
                 })   .state('admin.TimeTables.classTimeTable', {
                                        url: '/classTimeTable',
                                        title: "ClassTimeTable List",
                                        controller: function($scope) {
                                                                            $scope.classTTControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/classTimeTable.html'),
                                    }) .state('admin.TimeTables.newClassTimeTable', {
                                        url: '/classTimeTable/new',
                                        title: "New ClassTimeTable",
                                        resolve : helper.resolveFor('adminAddTimeTableControllers') ,
                                        templateUrl : helper.basepath('admin/newClassTimeTable.html'),
                                    }).
                                            
                                
            
                                        state('admin.TimeTables.teacherTimeTable', {
                                        url: '/teacherTimeTable',
                                        title: "TeacherTimeTable List",
                                        controller: function($scope) {
                                                                            $scope.teacherTTControllerFunction();
                                                                          } ,
                                        templateUrl : helper.basepath('admin/teacherTimeTable.html'),
                                    })
            ...
            .state('admin.Subjects', {
                     url: '/Subjects',
                     title: "Subjects",
                     resolve : helper.resolveFor('adminSubjectControllers','ngTable', 'ngTableExport'),
                     controller : function($state){ if($state.current.url == '/Subjects') {   $state.go('admin.Subjects.new'); }   } ,
                     templateUrl :  helper.basepath('admin/subject.html')
                 }).state('admin.Subjects.new', {
                     url: '/new',
                     title: "Add new subject",
                     resolve : helper.resolveFor('adminSubjectControllers','ngTable', 'ngTableExport'),
                     templateUrl :  helper.basepath('admin/newsubject.html')
                 }).state('admin.Subjects.list', {
                     url: '/list',
                     title: "Subject List",
                     resolve : helper.resolveFor('adminSubjectControllers','ngTable', 'ngTableExport'),
                     templateUrl :  helper.basepath('admin/subjectlist.html')
					  }).state('admin.Subjects.edit', {
                    url : "/id/{sid:[0-9]{1,9}}",
                    title: "Edit Subject",
                    resolve : helper.resolveFor('adminSubjectEditControllers'),
                    templateUrl :  helper.basepath('admin/editSubject.html')
                
                 }).state('admin.Subjects.classSubjects', {
                     url: '/classSubjects',
                     title: "Subject List",
                     
                     controller : function($scope){ $scope.classSubjectControllerFunction() } ,
                     templateUrl :  helper.basepath('admin/classSubjects.html')
                 })
            ...
            .state('admin.Payments',{
                ...
                url:'/Payments',
                title : 'Payments',
                controller : function($state){ if($state.current.url == '/Payments') {   $state.go('admin.Payments.newFee'); }   } ,
                resolve : helper.resolveFor('adminPaymentControllers','ngTable', 'ngTableExport'),
                templateUrl: helper.basepath('admin/payment.html')
                        }).state('admin.Payments.classList',{
                            url:'/classList',
                            title : 'Classwise List',
                            controller: function($scope){ $scope.classPayments() },
                            templateUrl: helper.basepath('admin/classPayments.html')
                         })
                            .state('admin.Payments.newFee',{
                            url:'/newFee',
                            title : 'Add new Fee',
                            controller: function($scope){ $scope.newFee() },
                            templateUrl: helper.basepath('admin/newFee.html')
                         })
                                 
                            .state('admin.Payments.studentPaySchedule',{
                            url:'/studentPaySchedule',
                            title : 'Configure student payment schedule',
                            controller: function($scope){ $scope.studentPaySchedule() },
                            templateUrl: helper.basepath('admin/studentPaySchedule.html')
                         })
                                 
                            .state('admin.Payments.pay',{
                            url:'/pay',
                            title : 'Configure student payment schedule',
                            controller: function($scope){ $scope.payFees() },
                            templateUrl: helper.basepath('admin/payStudentFees.html')
                         })
                ...
                // Admin Mail box states  
                .state('admin.mailbox', {
                    url: '/mailbox',
                    title: 'Mailbox',
                    abstract: true,
                    templateUrl: helper.basepath('admin/mailbox.html'),
                         resolve: helper.resolveFor('ngWig','adminMailBoxControllers')
                  
                })
                .state('admin.mailbox.folder', {
                    url: '/folder/:folder',
                    title: 'Mailbox',
                    templateUrl: helper.basepath('admin/mailbox-inbox.html')
                })
                .state('admin.mailbox.view', {
                    url : "/{mid:[0-9]{1,4}}",
                    title: 'View mail',
                    templateUrl: helper.basepath('admin/mailbox-view.html'),
                    resolve: helper.resolveFor('ngWig')
                })
                .state('admin.mailbox.compose', {
                    url: '/compose',
                    title: 'Mailbox',
                    templateUrl: helper.basepath('admin/mailbox-compose.html'),
                      resolve: helper.resolveFor('ngWig','adminComposeControllers')
                }) .state('app.widgets', {
                            url: '/widgets',
                            title: 'Widgets',
    ...
    //PARENT APP ROUTING 
     .state('parent', {
        ...
        abstract: true,
        controller:'AppController',
        templateUrl: helper.basepath('parent/app.html'),
        ...
        resolve: helper.resolveFor('fastclick', 'modernizr', 'icons', 'screenfull', 'animo', 'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl','ngTable', 'ngTableExport')
                                ...
                                url: '/home',
                                title: 'Home',  
                                 resolve: helper.resolveFor('parentHomeControllers'),
                                templateUrl: helper.basepath('parent/home.html'),
                                data: {
                                            displayName: 'Home'
                                        }

                            }). state('parent.home.dashboard', {
                                url: '/dashboard',
                                title: 'Home',  
                                 resolve: helper.resolveFor('parentHomeControllers'),
                                templateUrl: helper.basepath('parent/home.html'),
                            ...
                            .state('parent.home.homeworks', {
                                url: '/homework',
                                title: 'HomeWork',
                                controller:function(){console.log("Homeee") },
                                templateUrl: helper.basepath('parent/homework.html'),
                                resolve: helper.resolveFor('parentHomeworkControllers'),
                                data: {
                                            displayName: 'Homework'
                                        }
                            }).state('parent.home.attendance', {
                                url: '/attendance',
                                title: 'Attendance',
                                templateUrl: helper.basepath('parent/attendance.html'),
                                resolve: helper.resolveFor('parentAttendanceControllers'),
                                data: {
                                            displayName: 'Attendance'
                                        }
                            }).state('parent.home.timetable', {
                                url: '/timetable',
                                title: 'TimeTables',
                                templateUrl: helper.basepath('parent/timetable.html'),
                                resolve: helper.resolveFor('parentTimeTableControllers'),
                                data: {
                                            displayName: 'TimeTable'
                                        }
                            }).state('parent.home.exams', {
                                url: '/exams',
                                title: 'Exams',
                                templateUrl: helper.basepath('parent/exams.html'),
                                resolve: helper.resolveFor('parentExamsControllers','slimscroll'),
                                
                                data: {
                                            displayName: 'Exams'
                                        }
                                                }).state('parent.home.exams.examDetails', {
                                                    url: '/details',
                                                    title: 'Exam details',
                                                    templateUrl: helper.basepath('parent/examDetails.html'),
                                                    resolve: helper.resolveFor('parentExamsControllers'),
                                                    data: {
                                                                displayName: 'Exam Details'
                                                            }
                                                }).state('parent.home.exams.examResult', {
                                                    url: '/result',
                                                    title: 'Exam Results',
                                                    templateUrl: helper.basepath('parent/examResult.html'),
                                                    resolve: helper.resolveFor('parentExamsControllers'),
                                                    data: {
                              ...
                              .state('parent.home.notice', {
                                url: '/notice',
                                title: 'Notice',
                                templateUrl: helper.basepath('parent/notice.html'),
                                resolve: helper.resolveFor('parentNoticeControllers','ngWig'),
                                data: {
                                            displayName: 'Notices'
                                        }
                            }).state('parent.home.mail', {
                                url: '/mail',
                                title: 'MailBox',
                                abstract: true,
                                templateUrl: helper.basepath('parent/mailbox.html'),
                                resolve: helper.resolveFor('parentMailControllers'),
                                data: {
                                            displayName: 'Mail'
                                        }
                            }).state('parent.home.mail.folder', {
                                                        url: '/folder/:folder',
                                                        title: 'Mailbox',
                                                        templateUrl: helper.basepath('parent/mailbox-inbox.html')
                                                    })
                                                    .state('parent.home.mail.view', {
                                                        url : "/{mid:[0-9]{1,4}}",
                                                        title: 'View mail',
                                                        templateUrl: helper.basepath('parent/mailbox-view.html'),
                                                        resolve: helper.resolveFor('ngWig')
                                                    })
                                                    .state('parent.home.mail.compose', {
                                                        url: '/compose',
                                                        title: 'Mailbox',
                                                        templateUrl: helper.basepath('parent/mailbox-compose.html'),
                                                        resolve: helper.resolveFor('ngWig')
                                                    })                  

                              .state('parent.home.calendar', {
                                url: '/calendar',
                                title: 'Calendar',
                                templateUrl: helper.basepath('parent/calendar.html'),
                                resolve: helper.resolveFor('parentCalendarControllers'),
                                data: {
                                            displayName: 'Calendar'
                                        }
                            }).state('parent.home.transport', {
                                url: '/transport',
                                title: 'Transport',
                                templateUrl: helper.basepath('parent/transport.html'),
                                resolve: helper.resolveFor('parentTransportControllers'),
                                data: {
                                            displayName: 'Transport'
                                        }
                            }).state('parent.home.profile', {
                                url: '/profile',
                                title: 'Profile',
                                templateUrl: helper.basepath('parent/profile.html'),
                                resolve: helper.resolveFor('parentProfileControllers'),
    ...
    //TEACHER APP ROUTING 
     .state('teacher', {
        ...
        abstract: true,
        controller:'AppController',
        templateUrl: helper.basepath('teacher/app.html'),

        resolve: helper.resolveFor('fastclick', 'modernizr', 'icons', 'screenfull', 'animo', 'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl','ngTable', 'ngTableExport')
           })              .state('teacher.home', {
                                url: '/home',
                                title: 'Home',  
                                 resolve: helper.resolveFor('teacherHomeControllers'),
                                templateUrl: helper.basepath('teacher/home.html'),
                                data: {
                                            displayName: 'Home'
                                        }

                            }) .state('teacher.home.homeworks', {
                                url: '/homework',
                                title: 'HomeWork',
                                controller:function(){ },
                                templateUrl: helper.basepath('teacher/homework.html'),
                                resolve: helper.resolveFor('teacherHomeworkControllers','ui.select'),
                                data: {
                                            displayName: 'Assign Tasks'
                                        }
                            }).state('teacher.home.attendance', {
                                url: '/attendance',
                                title: 'Attendance',
                                controller:function(){ },
                                templateUrl: helper.basepath('teacher/attendance.html'),
                                resolve: helper.resolveFor('teacherAttendanceControllers','codemirror', 'moment', 'taginput','inputmask','localytics.directives', 'ui.bootstrap-slider', 'ngWig', 'filestyle', 'textAngular', 'textAngularSetup'),
                            ...
                            .state('teacher.home.mail', {
                                url: '/mail',
                                title: 'MailBox',
                                abstract: true,
                                templateUrl: helper.basepath('teacher/mailbox.html'),
                                resolve: helper.resolveFor('teacherMailControllers'),
                                data: {
                                            displayName: 'Mail'
                                        }
                            }).state('teacher.home.mail.folder', {
                                                        url: '/folder/:folder',
                                                        title: 'Mailbox',
                                                        templateUrl: helper.basepath('/teacher/mailbox-inbox.html')
                                                    })
                                                    .state('teacher.home.mail.view', {
                                                        url : "/{mid:[0-9]{1,4}}",
                                                        title: 'View mail',
                                                        templateUrl: helper.basepath('/teacher/mailbox-view.html'),
                                                        resolve: helper.resolveFor('ngWig')
                                                    })
                                                    .state('teacher.home.mail.compose', {
                                                        url: '/compose',
                                                        title: 'Mailbox',
                                                        templateUrl: helper.basepath('/teacher/mailbox-compose.html'),
                                                        resolve: helper.resolveFor('ngWig','teacherComposeControllers')
                                                    })                 
...
// Add token on each http reqest after login
...
App.run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache','$location','$cookieStore','$http','Data','authService', function ($rootScope, $state, $stateParams, $window, $templateCache,$location,$cookieStore,$http,Data,authService) {
   ...
   /*for redirecting to login page if not logged in*/
    //$scope.isAuthenticated = $cookieStore.get("loggedIn");
    $rootScope.$state = $state;
    console.log("Now in Run")
    console.log($state.current.name)
    $rootScope.logStatus =function($cookieStore,$location){
                                                var factory = {}
                        ...
                        $rootScope.logOut = function() {
                             console.log('logOut called');
                              $rootScope.logoutWait = 'whirl traditional'
                             $http.post(Data.currentApiPoint+'/api/logout', {}, getHttpConfig()).
                                 success(function() {
    ...
    $rootScope.$on('$stateChangeStart',function($rootScope){         
    // check if user is navigating to anypage other than login, if so check for token, if token is not present redirect to login page   
                          ...
                          {  
                                              ...
                                              /*  var CurUserRole = $cookieStore.get("role")[0];
                                                var roleArray = {ROLE_ADMIN:"admin", ROLE_TEACHER:"teacher", ROLE_PARENT:'parent'}
                                                var role = roleArray[$cookieStore.get("role")];
                                                var baseDirectory ='/'+role;
                                                var currentBaseDirectory = $location.path().substr(0, $location.path().indexOf('/',1)); 
                                                var locationPath = $location.path();
                                                console.log("Current dir = "+currentBaseDirectory+' , required = '+baseDirectory);
                                              */
                                             }
   ...
   //end redirection
    ...
    $rootScope.app = {
      name: 'MyChild',
      description: 'Parent Teacher App...',
  ...
  .constant('APP_REQUIRES', {
    ...
    modules: [
      ...
      {name: 'ui.map',                    files: ['vendor/angular-ui-map/ui-map.js']} ,
        ...
        //custom js files (Controllers) starts from here
        
          {name:'gradeControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/grades.js'] } ,
          {name:'adminStudentControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/student.js'] } ,
           {name:'adminTeacherControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/teacher.js'] },
           {name:'adminExamControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/exam.js'] },
            {name:'adminTimeTableControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/timetable.js'] },
            {name:'adminAddTimeTableControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/addTimeTable.js'] },
             {name:'adminSubjectControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/subject.js'] } ,
             {name:'adminPaymentControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/payment.js'] },
             {name:'adminAttendanceControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/attendance.js' ]},
           {name:'saveStudentController' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/saveStudent.js' ]},
             {name:'adminEditTeacherController' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/editTeacher.js' ]},
               {name:'adminStudentEditController' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/editStudent.js' ]},
			    {name:'adminClassEditController' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/editClass.js' ]},
				 {name:'adminMailBoxControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/mail.js']},
                 {name:'adminComposeControllers' , files:['app/js/admin/services/services.js','app/js/admin/controllers/mailbox-compose.js']},
				  {name:'adminSubjectEditControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/editSubject.js' ]},
                {name:'adminEventListController' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/eventList.js' ]},
                 {name:'adminEventEditControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/editEvent.js' ]},
				 {name:'adminGalleryControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/gallery.js' ]},
        
        

             
             
             {name:'admiEventControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/events.js' ]},
              {name:'admiNoticeControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/notice.js' ]},
              {name:'admiNoticeEditControllers' , files:['app/js/admin/services/services.js' ,'app/js/admin/controllers/noticeEdit.js' ]},
             
             {name:'parentHomeControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/home.js']},
             {name:'parentHomeworkControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/homework.js']},
             {name:'parentAttendanceControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/attendance.js']},
              {name:'parentTimeTableControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/timetable.js']},
              {name:'parentExamsControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/exams.js']},
              {name:'parentNoticeControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/notice.js']},
               {name:'parentCalendarControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/calendar.js']},
                {name:'parentTransportControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/transport.js']},
                 {name:'parentMailControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/mail.js']},
                  {name:'parentProfileControllers' , files:['app/js/parent/services/services.js','app/js/parent/controllers/profile.js']},
              
              
                {name:'teacherHomeControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/home.js']},
                 {name:'teacherHomeworkControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/homework.js']},
                  {name:'teacherAttendanceControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/attendance.js']},
                   {name:'teacherMailControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/mail.js']},
                   {name:'teacherTimeTableControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/timetable.js']},
                 {name:'teacherComposeControllers' , files:['app/js/teacher/services/services.js','app/js/teacher/controllers/mailbox-compose.js']},
 ...
 * Provides a simple demo for pagination
 ...
 App.controller('dadminMailBoxControllers', ["$scope", "colors", function($scope, colors) {


  $scope.folders = [
    {name: 'Inbox',   folder: 'inbox',    icon: "fa-inbox" },
    {name: 'Starred', folder: 'starred', icon: "fa-star" },
    {name: 'Sent',    folder: 'sent',      icon: "fa-paper-plane-o" },
    {name: 'Draft',   folder: 'draft',     icon: "fa-edit" },
    {name: 'Trash',   folder: 'trash',   icon: "fa-trash"}
  ];
...
App.controller('SidebarController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'Utils','$cookieStore',
  function($rootScope, $scope, $state, $http, $timeout, Utils,$cookieStore){
    ...
    $scope.loadSidebarMenu = function() {
                                    ...
                                    var CurUserRole = $cookieStore.get("role")[0];
                                    console.log("Current ROle from Side Menu Picker : "+CurUserRole)
                                    var role = {ROLE_ADMIN:"admin", ROLE_TEACHER:"teacher", ROLE_PARENT:'parent'}
                                    role = role[CurUserRole] 
      var menuJson = 'server/'+role+'-sidebar-menu.json',
...
App.directive('myDatePicker', function() {
  return{
    ...
    link: function(scope, element){
      $(element).datepicker({dateFormat: "dd-mm-yyyy"});
    }
  };
});
...
App.run(["$rootScope","$cookieStore","$resource","$state",function($rootScope,$cookieStore,$resource,$state){
        
 
        $rootScope.username = ''
        if($cookieStore.get("role")){
                                                var CurUserRole = $cookieStore.get("role")[0];
                                                console.log("Current ROle from App.Run : "+CurUserRole);
                                                var role = {ROLE_ADMIN:"admin", ROLE_TEACHER:"teacher", ROLE_PARENT:'parent'};
                                                role=role[CurUserRole]; 
