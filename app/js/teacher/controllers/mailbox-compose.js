...
App.controller('MailComposeController', ['$scope', 'mails', '$stateParams','$http','$filter','APISource','$cookieStore', function($scope, mails, $stateParams,$http,$filter,APISource,$cookieStore) {
