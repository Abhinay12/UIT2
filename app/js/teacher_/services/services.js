...
App.factory('Grade', function($resource,APISource) {
 ...
 return $resource( APISource.currentApiPoint+'/app/admin/grades/:id?max='+100,
  {}, { 
    loan: { 
      method: 'GET',
      isArray: false 
...
App.factory('SchoolClasses', function($resource,APISource) {
 ...
 return $resource( APISource.currentApiPoint+'/app/admin/schoolclasses/:id?max='+100+'?sort=class_name&order=asc',
  {}, { 
    loan: { 
      method: 'GET',
      isArray: false 
